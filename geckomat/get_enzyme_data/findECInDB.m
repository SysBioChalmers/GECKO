function [EC,conflicts] = findECInDB(gene_set,DBprot,DBgenes,DBecNum,DBMW, geneIndex, geneHashMap)
% findInDB
...
%
%   Usage: [EC,conflicts] = findInDB(grRule,DBprot,DBgenes,DBecNum,DBMW)
%
