...
% - Prepare a folder in tutorials, or select another path whether all model-
...
%   tutorials/ecYeastGEM/model/yeast-GEM.xml
% - Modify the model adapter (at tutorials/ecYeastGEM/ecYeastGEMadapter.m)
