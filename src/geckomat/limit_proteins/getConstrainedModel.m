function [ecModel_batch,OptSigma] = getConstrainedModel(ecModel,modifications,name,parameters)
% getConstrainedModel
%
...
if ~isempty(solution.f)
    ...
    if (gRate-solution.x(ObjIndex))>0
        ...
        ecModel_batch = modifyKcats(ecModel_batch,gRate,modifications,name,parameters);
    else
