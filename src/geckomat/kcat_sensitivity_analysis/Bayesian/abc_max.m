...
%               an earlier run
%   bayData     structure with experimental data to be used
%       fluxData    data with various carbon sources, various growth rates,
%                   various environmental conditions, includes exchange
%                   rates
%       maxGrate    maximum growth rates on various carbon sources
%       zeroFlux    exchange reactions that are assumed to be carrying zero
