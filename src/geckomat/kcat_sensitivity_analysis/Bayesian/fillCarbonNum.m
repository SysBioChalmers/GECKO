...
% -------
% model : struct
%     ecModel with an added model.excarbon field.
...
% getcarbonnum  Get carbon numbers matching the model.
%
% Parameters
% ----------
% model : struct
...
%     (pre 3.0).
% exrxn : cell
%     exchange reactions to use for counting.
%
% Returns
% -------
% CarbonNum : double
%     carbon number for each exchange reaction.
% EXfors : cell
%     formulae of the exchanged metabolites.
% changedmets : cell
%     exchange reactions whose carbon number could not be determined.
%
